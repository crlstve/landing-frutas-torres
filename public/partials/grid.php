<section class="w-full flex flex-col bg-beige -mt-36 rounded-t-[6rem] lg:rounded-t-[8rem] py-32 relative">
    
    <h2 class="color-green text-3xl lg:text-8xl mx-auto text-center"><span class="-scale-y-1">?</span>QUIEN PUEDE PARTICIPAR?</h2>
